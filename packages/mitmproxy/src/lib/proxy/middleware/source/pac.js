...
function createPacClient (pacFilePath) {
  ...
  /* eslint-disable eslint-comments/no-unlimited-disable, regexp/no-super-linear-backtracking, regexp/no-unused-capturing-group, regexp/optimal-quantifier-concatenation, regexp/prefer-character-class, regexp/prefer-d, regexp/prefer-w, style/no-floating-promise */
